namespace Wulveagfin.NKeys
{
	...
	/// </summary>
	public class NKeyValue<A, B, C, D, E, F, G, H, I, VALUE>
	{
		...
		public NKeyValue(A key0, B key1, C key2, D key3, E key4, F key5, G key6, H key7, I key8,  VALUE val)
		{
			this.Key0 = key0;
			this.Key1 = key1;
			this.Key2 = key2;
		...
		{
			return $"{Key0}, {Key1}, {Key2}, {Key3}, {Key4}, {Key5}, {Key6}, {Key7}, {Key8}, {Value}";
		}
	}
	...
	/// </summary>
	public class NKeyHash<A, B, C, D, E, F, G, H, I, VALUE> : IDisposable, IEnumerable<NKeyValue<A, B, C, D, E, F, G, H, I, VALUE>>
	{
		...
		public NKeyHash(UnderlyingHashType cubeUnderlyingHashType = UnderlyingHashType.Dictionary)
		{
			...
			this.Values = new NKeyHash<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>>>(this.UnderlyingHashType);
		}

		/// <summary>
		/// Private internal storage object for Values
		/// </summary>
		private NKeyHash<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>>> Values;
		...
		{
			NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>> bsA1l;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
				NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>> csA1l;
				if (bsA1l.TryGetValue(b, out csA1l))
				{
					NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>> dsA1l;
					if (csA1l.TryGetValue(c, out dsA1l))
					{
						NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>> esA1l;
						if (dsA1l.TryGetValue(d, out esA1l))
						{
							NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>> fsA1l;
							if (esA1l.TryGetValue(e, out fsA1l))
							{
								NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>> gsA1l;
								if (fsA1l.TryGetValue(f, out gsA1l))
								{
									NKeyHash<H, NKeyHash<I, VALUE>> hsA1l;
									if (gsA1l.TryGetValue(g, out hsA1l))
									{
										NKeyHash<I, VALUE> isA1l;
		...
		public VALUE this[A a, B b, C c, D d, E e, F f, G g, H h, I i]
		{
			get { return Get(a, b, c, d, e, f, g, h, i); }
			set { this.Upsert(true, a, b, c, d, e, f, g, h, i, value); }
		}
		...
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public VALUE Get(A a, B b, C c, D d, E e, F f, G g, H h, I i)
		{
			return this.Values[a][b][c][d][e][f][g][h][i];
		}
		...
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public VALUE Get(out bool exists, VALUE defaultData, A a, B b, C c, D d, E e, F f, G g, H h, I i)
		{
			exists = false;
							...
							if (esA1l.TryGetValue(e, out fsA1l))
							{
								...
								if (fsA1l.TryGetValue(f, out gsA1l))
								{
									...
									if (gsA1l.TryGetValue(g, out hsA1l))
									{
										...
										{
											VALUE val;
											if (isA1l.TryGetValue(i, out val))
											{
												exists = true;
												return val;
											}
		...
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public bool TryGetValue(A a, B b, C c, D d, E e, F f, G g, H h, I i, out VALUE val)
		{
			bool exist = false;
			val = Get(out exist, default(VALUE), a, b, c, d, e, f, g, h, i);
			return exist;
		}
		...
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Add(A a, B b, C c, D d, E e, F f, G g, H h, I i, VALUE val)
		{
			this.Upsert(false, a, b, c, d, e, f, g, h, i, val);
		}
		...
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		public void Delete(A a, B b, C c, D d, E e, F f, G g, H h, I i)
		{
			this.Remove(a, b, c, d, e, f, g, h, i);
		}
		...
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		public void Remove(A a, B b, C c, D d, E e, F f, G g, H h, I i)
		{
			 NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>> bsA1l;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
		...
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Upsert(A a, B b, C c, D d, E e, F f, G g, H h, I i, VALUE val)
		{
			this.Upsert(true, a, b, c, d, e, f, g, h, i,  val);
		}
		...
		/// <param name="i">Key8 of type I, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Upsert(bool replaceExistingData, A a, B b, C c, D d, E e, F f, G g, H h, I i, VALUE val)
		{
			int level = 0;
			NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>> bsA1l = null;
			NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>> csA1l = null;
			NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>> dsA1l = null;
			NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>> esA1l = null;
			NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>> fsA1l = null;
			NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>> gsA1l = null;
			NKeyHash<H, NKeyHash<I, VALUE>> hsA1l = null;
			NKeyHash<I, VALUE> isA1l = null;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
				if (bsA1l.TryGetValue(b, out csA1l))
				{
			...
			if (level == 1) { bsA1l = new  NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>>(this.UnderlyingHashType); this.Values.Add(a, bsA1l); level++; }
			if (level == 2) { csA1l = new  NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>(this.UnderlyingHashType); bsA1l.Add(b, csA1l); level++; }
			if (level == 3) { dsA1l = new  NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>(this.UnderlyingHashType); csA1l.Add(c, dsA1l); level++; }
			if (level == 4) { esA1l = new  NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>(this.UnderlyingHashType); dsA1l.Add(d, esA1l); level++; }
			if (level == 5) { fsA1l = new  NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>(this.UnderlyingHashType); esA1l.Add(e, fsA1l); level++; }
			if (level == 6) { gsA1l = new  NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>(this.UnderlyingHashType); fsA1l.Add(f, gsA1l); level++; }
			if (level == 7) { hsA1l = new  NKeyHash<H, NKeyHash<I, VALUE>>(this.UnderlyingHashType); gsA1l.Add(g, hsA1l); level++; }
			if (level == 8) { isA1l = new  NKeyHash<I, VALUE>(this.UnderlyingHashType); hsA1l.Add(h, isA1l); level++; }
			if (level == 9) {isA1l.Add(i, val); }
		}
		...
		/// Returns an enumerator that iterates through the collection.
		/// </summary>
		public IEnumerator<NKeyValue<A, B, C, D, E, F, G, H, I, VALUE>> GetEnumerator()
		{
			foreach (NKeyValue<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>>> a in  this.Values)
			{
				foreach (NKeyValue<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>>> b in a.Value)
				{
					foreach (NKeyValue<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>>> c in b.Value)
					{
						foreach (NKeyValue<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>>> d in c.Value)
						{
							foreach (NKeyValue<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>>> e in d.Value)
							{
								foreach (NKeyValue<F, NKeyHash<G, NKeyHash<H, NKeyHash<I, VALUE>>>> f in e.Value)
								{
									foreach (NKeyValue<G, NKeyHash<H, NKeyHash<I, VALUE>>> g in f.Value)
									{
										foreach (NKeyValue<H, NKeyHash<I, VALUE>> h in g.Value)
										{
											foreach (NKeyValue<I, VALUE> i in h.Value)
											{
												yield return new NKeyValue<A, B, C, D, E, F, G, H, I, VALUE>(a.Key, b.Key, c.Key, d.Key, e.Key, f.Key, g.Key, h.Key, i.Key, i.Value);
											}
										}
									}
								}
