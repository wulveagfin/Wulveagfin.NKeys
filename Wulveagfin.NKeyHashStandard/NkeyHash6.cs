namespace Wulveagfin.NKeys
{
	...
	/// </summary>
	public class NKeyValue<A, B, C, D, E, F, VALUE>
	{
		...
		public NKeyValue(A key0, B key1, C key2, D key3, E key4, F key5,  VALUE val)
		{
			this.Key0 = key0;
			this.Key1 = key1;
			this.Key2 = key2;
		...
		{
			return $"{Key0}, {Key1}, {Key2}, {Key3}, {Key4}, {Key5}, {Value}";
		}
	}
	...
	/// </summary>
	public class NKeyHash<A, B, C, D, E, F, VALUE> : IDisposable, IEnumerable<NKeyValue<A, B, C, D, E, F, VALUE>>
	{
		...
		public NKeyHash(UnderlyingHashType cubeUnderlyingHashType = UnderlyingHashType.Dictionary)
		{
			...
			this.Values = new NKeyHash<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>>>(this.UnderlyingHashType);
		}

		/// <summary>
		/// Private internal storage object for Values
		/// </summary>
		private NKeyHash<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>>> Values;
		...
		{
			NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>> bsA1l;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
				NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>> csA1l;
				if (bsA1l.TryGetValue(b, out csA1l))
				{
					NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>> dsA1l;
					if (csA1l.TryGetValue(c, out dsA1l))
					{
						NKeyHash<E, NKeyHash<F, VALUE>> esA1l;
						if (dsA1l.TryGetValue(d, out esA1l))
						{
							NKeyHash<F, VALUE> fsA1l;
		...
		public VALUE this[A a, B b, C c, D d, E e, F f]
		{
			get { return Get(a, b, c, d, e, f); }
			set { this.Upsert(true, a, b, c, d, e, f, value); }
		}
		...
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public VALUE Get(A a, B b, C c, D d, E e, F f)
		{
			return this.Values[a][b][c][d][e][f];
		}
		...
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public VALUE Get(out bool exists, VALUE defaultData, A a, B b, C c, D d, E e, F f)
		{
			exists = false;
				...
				if (bsA1l.TryGetValue(b, out csA1l))
				{
					...
					if (csA1l.TryGetValue(c, out dsA1l))
					{
						...
						if (dsA1l.TryGetValue(d, out esA1l))
						{
							...
							{
								VALUE val;
								if (fsA1l.TryGetValue(f, out val))
								{
									exists = true;
									return val;
								}
		...
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public bool TryGetValue(A a, B b, C c, D d, E e, F f, out VALUE val)
		{
			bool exist = false;
			val = Get(out exist, default(VALUE), a, b, c, d, e, f);
			return exist;
		}
		...
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Add(A a, B b, C c, D d, E e, F f, VALUE val)
		{
			this.Upsert(false, a, b, c, d, e, f, val);
		}
		...
		/// <param name="e">Key4 of type E, of [key0 key1.... keyN value] pair.</param>
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		public void Delete(A a, B b, C c, D d, E e, F f)
		{
			this.Remove(a, b, c, d, e, f);
		}
		...
		/// <param name="e">Key4 of type E, of [key0 key1.... keyN value] pair.</param>
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		public void Remove(A a, B b, C c, D d, E e, F f)
		{
			 NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>> bsA1l;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
		...
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Upsert(A a, B b, C c, D d, E e, F f, VALUE val)
		{
			this.Upsert(true, a, b, c, d, e, f,  val);
		}
		...
		/// <param name="f">Key5 of type F, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Upsert(bool replaceExistingData, A a, B b, C c, D d, E e, F f, VALUE val)
		{
			int level = 0;
			NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>> bsA1l = null;
			NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>> csA1l = null;
			NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>> dsA1l = null;
			NKeyHash<E, NKeyHash<F, VALUE>> esA1l = null;
			NKeyHash<F, VALUE> fsA1l = null;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
				if (bsA1l.TryGetValue(b, out csA1l))
				{
			...
			if (level == 1) { bsA1l = new  NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>>(this.UnderlyingHashType); this.Values.Add(a, bsA1l); level++; }
			if (level == 2) { csA1l = new  NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>(this.UnderlyingHashType); bsA1l.Add(b, csA1l); level++; }
			if (level == 3) { dsA1l = new  NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>(this.UnderlyingHashType); csA1l.Add(c, dsA1l); level++; }
			if (level == 4) { esA1l = new  NKeyHash<E, NKeyHash<F, VALUE>>(this.UnderlyingHashType); dsA1l.Add(d, esA1l); level++; }
			if (level == 5) { fsA1l = new  NKeyHash<F, VALUE>(this.UnderlyingHashType); esA1l.Add(e, fsA1l); level++; }
			if (level == 6) {fsA1l.Add(f, val); }
		}
		...
		/// Returns an enumerator that iterates through the collection.
		/// </summary>
		public IEnumerator<NKeyValue<A, B, C, D, E, F, VALUE>> GetEnumerator()
		{
			foreach (NKeyValue<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>>> a in  this.Values)
			{
				foreach (NKeyValue<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>>> b in a.Value)
				{
					foreach (NKeyValue<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, VALUE>>>> c in b.Value)
					{
						foreach (NKeyValue<D, NKeyHash<E, NKeyHash<F, VALUE>>> d in c.Value)
						{
							foreach (NKeyValue<E, NKeyHash<F, VALUE>> e in d.Value)
							{
								foreach (NKeyValue<F, VALUE> f in e.Value)
								{
									yield return new NKeyValue<A, B, C, D, E, F, VALUE>(a.Key, b.Key, c.Key, d.Key, e.Key, f.Key, f.Value);
								}
							}
						}
					}
