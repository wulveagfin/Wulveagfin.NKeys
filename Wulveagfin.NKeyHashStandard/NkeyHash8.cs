namespace Wulveagfin.NKeys
{
	...
	/// </summary>
	public class NKeyValue<A, B, C, D, E, F, G, H, VALUE>
	{
		...
		public NKeyValue(A key0, B key1, C key2, D key3, E key4, F key5, G key6, H key7,  VALUE val)
		{
			this.Key0 = key0;
			this.Key1 = key1;
			this.Key2 = key2;
		...
		{
			return $"{Key0}, {Key1}, {Key2}, {Key3}, {Key4}, {Key5}, {Key6}, {Key7}, {Value}";
		}
	}
	...
	/// </summary>
	public class NKeyHash<A, B, C, D, E, F, G, H, VALUE> : IDisposable, IEnumerable<NKeyValue<A, B, C, D, E, F, G, H, VALUE>>
	{
		...
		/// </summary>
		private NKeyHash<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>>> Values;
		...
		{
			NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>> bsA1l;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
				NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>> csA1l;
				if (bsA1l.TryGetValue(b, out csA1l))
				{
					NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>> dsA1l;
					if (csA1l.TryGetValue(c, out dsA1l))
					{
						NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>> esA1l;
						if (dsA1l.TryGetValue(d, out esA1l))
						{
							NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>> fsA1l;
							if (esA1l.TryGetValue(e, out fsA1l))
							{
								NKeyHash<G, NKeyHash<H, VALUE>> gsA1l;
								if (fsA1l.TryGetValue(f, out gsA1l))
								{
									NKeyHash<H, VALUE> hsA1l;
		...
		public VALUE this[A a, B b, C c, D d, E e, F f, G g, H h]
		{
			get { return Get(a, b, c, d, e, f, g, h); }
			set { this.Upsert(true, a, b, c, d, e, f, g, h, value); }
		}
		...
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public VALUE Get(A a, B b, C c, D d, E e, F f, G g, H h)
		{
			return this.Values[a][b][c][d][e][f][g][h];
		}
		...
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public VALUE Get(out bool exists, VALUE defaultData, A a, B b, C c, D d, E e, F f, G g, H h)
		{
			exists = false;
						...
						if (dsA1l.TryGetValue(d, out esA1l))
						{
							...
							if (esA1l.TryGetValue(e, out fsA1l))
							{
								...
								if (fsA1l.TryGetValue(f, out gsA1l))
								{
									...
									{
										VALUE val;
										if (hsA1l.TryGetValue(h, out val))
										{
											exists = true;
											return val;
										}
		...
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		/// <returns>Returns the VALUE portion of [key0 key1.... keyN value], if it exists, otherwise Default(VALUE) (or if specified the defaultData) is returned.</returns>
		public bool TryGetValue(A a, B b, C c, D d, E e, F f, G g, H h, out VALUE val)
		{
			bool exist = false;
			val = Get(out exist, default(VALUE), a, b, c, d, e, f, g, h);
			return exist;
		}
		...
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Add(A a, B b, C c, D d, E e, F f, G g, H h, VALUE val)
		{
			this.Upsert(false, a, b, c, d, e, f, g, h, val);
		}
		...
		/// <param name="g">Key6 of type G, of [key0 key1.... keyN value] pair.</param>
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		public void Delete(A a, B b, C c, D d, E e, F f, G g, H h)
		{
			this.Remove(a, b, c, d, e, f, g, h);
		}
		...
		/// <param name="g">Key6 of type G, of [key0 key1.... keyN value] pair.</param>
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		public void Remove(A a, B b, C c, D d, E e, F f, G g, H h)
		{
			 NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>> bsA1l;
			if (this.Values.TryGetValue(a, out bsA1l))
			{
		...
		/// <param name="h">Key7 of type H, of [key0 key1.... keyN value] pair.</param>
		/// <param name="val">Value of [key0 key1.... keyN value] pair.</param>
		public void Upsert(A a, B b, C c, D d, E e, F f, G g, H h, VALUE val)
		{
			this.Upsert(true, a, b, c, d, e, f, g, h,  val);
		}
		...
		public void Upsert(bool replaceExistingData, A a, B b, C c, D d, E e, F f, G g, H h, VALUE val)
		{
			...
			if (level == 1) { bsA1l = new  NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>>(this.UnderlyingHashType); this.Values.Add(a, bsA1l); level++; }
			if (level == 2) { csA1l = new  NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>(this.UnderlyingHashType); bsA1l.Add(b, csA1l); level++; }
			if (level == 3) { dsA1l = new  NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>(this.UnderlyingHashType); csA1l.Add(c, dsA1l); level++; }
			if (level == 4) { esA1l = new  NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>(this.UnderlyingHashType); dsA1l.Add(d, esA1l); level++; }
			if (level == 5) { fsA1l = new  NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>(this.UnderlyingHashType); esA1l.Add(e, fsA1l); level++; }
			if (level == 6) { gsA1l = new  NKeyHash<G, NKeyHash<H, VALUE>>(this.UnderlyingHashType); fsA1l.Add(f, gsA1l); level++; }
			if (level == 7) { hsA1l = new  NKeyHash<H, VALUE>(this.UnderlyingHashType); gsA1l.Add(g, hsA1l); level++; }
			if (level == 8) {hsA1l.Add(h, val); }
		}
		...
		/// Returns an enumerator that iterates through the collection.
		/// </summary>
		public IEnumerator<NKeyValue<A, B, C, D, E, F, G, H, VALUE>> GetEnumerator()
		{
			foreach (NKeyValue<A, NKeyHash<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>>> a in  this.Values)
			{
				foreach (NKeyValue<B, NKeyHash<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>>> b in a.Value)
				{
					foreach (NKeyValue<C, NKeyHash<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>>> c in b.Value)
					{
						foreach (NKeyValue<D, NKeyHash<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>>> d in c.Value)
						{
							foreach (NKeyValue<E, NKeyHash<F, NKeyHash<G, NKeyHash<H, VALUE>>>> e in d.Value)
							{
								foreach (NKeyValue<F, NKeyHash<G, NKeyHash<H, VALUE>>> f in e.Value)
								{
									foreach (NKeyValue<G, NKeyHash<H, VALUE>> g in f.Value)
									{
										foreach (NKeyValue<H, VALUE> h in g.Value)
										{
											yield return new NKeyValue<A, B, C, D, E, F, G, H, VALUE>(a.Key, b.Key, c.Key, d.Key, e.Key, f.Key, g.Key, h.Key, h.Value);
										}
									}
								}
							}
